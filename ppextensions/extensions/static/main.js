define(["jquery",
    ...
    "./github",
    "./scheduler"
    ], function($, Jupyter, utils, githuboperation, scheduleoperation){
    ...
    function load_ipython_extension(){
        ...
        var github_html = $( "<li role=\"presentation\" id=\"privategithubpush\">\n" +
        ...
        github_html.insertAfter($("#gitpull"));
        ...
        var url_scheduler_whitelist = utils.url_path_join(Jupyter.notebook_list.base_url, '/scheduler/is_whitelist');
        var url_whitelist = utils.url_path_join(Jupyter.notebook_list.base_url, '/github/is_whitelist');
        var url_gittoken = utils.url_path_join(Jupyter.notebook_list.base_url, '/github/gittoken');
                ...
                $.get(url_gittoken, function(res){
                    if (res == "False"){
                        ...
                        if(selected.length == 1){
                           $.get(url_scheduler_whitelist, function(res){
                                if (res == 'True'){
