    ...
    ScheduleOperation.prototype.schedule_selected = function () {
        ...
        every_unit.change(function() {
           switch (every_unit.val()){
               case "hours":
                   lst = Array(20).fill(0).map((i,j) => j + 4);
                   break;
               case "days":
        ...
        var runs_list = ['1 time', '2 times', '3 times', '4 times', '5 times', '10 times', '50 times'];
        ...
        buttons : {
            ...
            Schedule : {
                ...
                click: function() {
                    ...
                    var num_of_run = $('#runs').val().split(" ")[0];
                                ...
                                buttons : {
                                    ...
                                    Override : {
                                        ...
                                        click:  function(){
                                                ...
                                                //$.post(url + '?notebook_name=' +  notebook_name, function(){schedule();});
                                        }}
                                    }
                                });
                        }
